...
def make_train_test(df_train, df_test):
    vectorizer = CountVectorizer(ngram_range=(8,8), stop_words='english')
...
if __name__ == '__main__':
    ...
    df_diff['Sentiment_predict'] = clf.predict(X_train)    
    df_diff = df_diff[df_diff['Sentiment'] != df_diff['Sentiment_predict']]
    ...
    df_diff.to_csv(clfFolder + "diff.csv", index = False)
